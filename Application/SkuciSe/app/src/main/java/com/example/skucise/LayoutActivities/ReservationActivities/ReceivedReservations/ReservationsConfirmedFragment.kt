...
import com.example.skucise.adapter.ReceivedReservationsDefaultAdapter
 ...
 * Use the [ReservationsConfirmedFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ReservationsConfirmedFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userId?.toLong()?.let { reservationViewModel.getReceivedReservations(it, Status.Confirmed) }
    ...
    private fun initReservations(view: View) {
        ...
        recyclerViewReceivedReservation.adapter = ReceivedReservationsDefaultAdapter(dataholderReservation)
    }
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_reservations_confirmed, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ReservationsConfirmedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ReservationsConfirmedFragment().apply {
