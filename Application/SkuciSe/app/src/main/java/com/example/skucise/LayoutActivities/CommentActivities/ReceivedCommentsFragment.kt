 ...
 * Use the [ReceivedCommentsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ReceivedCommentsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_received_comments, container, false)
        var receivedText = view.findViewById<TextView>(R.id.primljeneRecenzijeText)
//        receivedText.visibility = View.GONE

        recyclerViewComments = view.findViewById(R.id.recyclerViewReceivedComments)
        ...
        advertViewModel.getReceivedComments(id)
    ...
    companion object {
         ...
         * @return A new instance of fragment ReceivedCommentsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ReceivedCommentsFragment().apply {
