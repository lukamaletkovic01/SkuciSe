 ...
 * Use the [SentReservationRejectedFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SentReservationRejectedFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userId?.toLong()?.let { reservationViewModel.getSentReservations(it, Status.Rejected) }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_sent_reservation_rejected, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SentReservationRejectedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SentReservationRejectedFragment().apply {
