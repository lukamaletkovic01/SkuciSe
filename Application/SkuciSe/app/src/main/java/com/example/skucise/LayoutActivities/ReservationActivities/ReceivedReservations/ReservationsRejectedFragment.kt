 ...
 * Use the [ReservationsRejectedFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ReservationsRejectedFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userId?.toLong()?.let { reservationViewModel.getReceivedReservations(it, Status.Rejected) }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_reservations_rejected, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment ReservationsRejectedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ReservationsRejectedFragment().apply {
