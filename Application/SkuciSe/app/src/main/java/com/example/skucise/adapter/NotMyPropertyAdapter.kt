...
class NotMyPropertyAdapter(dataholder: ArrayList<Advert>) :
    RecyclerView.Adapter<NotMyPropertyAdapter.MyPropertyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyPropertyViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(com.example.skucise.R.layout.item_profile_page_adverts, parent, false)
